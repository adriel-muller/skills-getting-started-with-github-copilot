...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim lessons, relay races, and water safety drills",
    ...
    "Debate Team": {
        "description": "Public speaking, argument development, and competitive debate",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Build and program robots for challenges and exhibitions",
